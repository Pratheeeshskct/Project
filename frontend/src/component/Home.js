            ...
            return (
                ...
                update == val.id && prop.data[ind].id || (update == 0 && val.id == 0) ?
                    ...
                    <tr className="update-value">
                        ...
                        <td><input type="text" placeholder={val.age} /></td>
                        <td><input type="text" placeholder={val.gender} /></td>
                        <td><input type="text" placeholder={val.address} /></td>
                        <td><input type="text" placeholder={val.mobileNumber} /></td>
                        <td><input type="text" placeholder={val.email} /></td>
                        <td>
